package entregas.sanmiguelHector.reto005;
...
public class Aspiradora {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            moverGato(superficie, posicionGato);
    ...
    static void moverGato(int[][] superficie, int[] posicionGato) {
        ...
        int random = (int) (Math.random() * movimientos.length);

        int nuevoX = x + movimientos[random][0];
        int nuevoY = y + movimientos[random][1];

        if (nuevoX >= 0 && nuevoX < superficie.length &&
            nuevoY >= 0 && nuevoY < superficie[0].length) {
            posicionGato[0] = nuevoX;
            posicionGato[1] = nuevoY;
        }

        if (superficie[posicionGato[0]][posicionGato[1]] < 4) {
