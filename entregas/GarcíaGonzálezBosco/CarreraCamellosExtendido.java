...
public class CarreraCamellosExtendido {
    public static void main(String[] args) {
        ...
        final int AVANCE4 = 6;
        final double PROBABILIDAD_TROPIEZA = 0.1;
        final String AVANCE = " ";
        ...
        final int TURNOS_MAXIMOS = 50;
        boolean turnosGastados = false;
        ...
        do {
            ...
            System.out.println("Turno: " + turnos+" - Está en la casilla "+posicion);
            System.out.println("Elija un agujero (1,2,3,4): ");
            int agujeroElegido = scanner.nextInt();

            if(Math.random()<PROBABILIDAD_TROPIEZA){
                System.out.println("El camello ha tropezado, no avanzas este turno y pierdes los proximos dos");
                turnos = turnos+2;
            }else{
            if (agujeroElegido == 1) {
            ...
            turnosGastados = turnos >= TURNOS_MAXIMOS;
        } while (!algunGanador && !turnosGastados);
    }
}
