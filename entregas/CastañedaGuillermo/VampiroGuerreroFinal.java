...
class VampiroGuerreroAvanzado {
    public static void main(String[] args) {
        ...
        System.out.println("¡Bienvenido a la batalla entre el vampiro y el guerrero!");
        ...
        while (!vampiroMuerto && !guerreroMuerto) {
            ...
            if (!guerreroDesmayado && !pocionActiva) {
                ...
                System.out.println("4 -> Defenderse (80% de éxito, reduce ataque del vampiro en 5 pts)");
